...
Questions, feedback & ideas are all welcome - just [open an issue](https://github.com/davisonio/bacon/issues)! :smile:

Alternatively you can [contact the authors](https://github.com/davisonio/bacon#authors).
